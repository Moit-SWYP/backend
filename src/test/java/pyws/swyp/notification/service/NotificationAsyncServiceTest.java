...
class NotificationAsyncServiceTest {
    ...
    void tokenMembers_areSent() throws Exception {
        ...
        // when
        notificationAsyncService.createAndSendMulticast(List.of(memberId), cmd);
    ...
    void partialTokenMembers_areHandledCorrectly() throws Exception {
        ...
        // when
        notificationAsyncService.createAndSendMulticast(List.of(member1, member2, member3), cmd);
